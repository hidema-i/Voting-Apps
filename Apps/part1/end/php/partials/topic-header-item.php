...
?>
  <div>
    <?php if ($from_top_page) : ?>
      <h1 class="sr-onry">スニーカーアンケート</h1>
      <h2 class="h1">
...
?>
  ...
  <?php else : ?> <div class="text-center mt-5">
      <div class="mb-2">ログインしてからアンケートに参加してください。</div>
